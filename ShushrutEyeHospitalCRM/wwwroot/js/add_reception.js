...
var val = $('#frmAddReception').validate({
    rules: {
        txtFirstName: {
            required: true,
        },
...
$('#btnReset').on('click', function () {
    $('#frmAddReception').validate().resetForm();
});
$(function () {
...
function CreateReception() {
    ...
    $.ajax({
        ...
        url: GetRoute("/Reception/AddReception"),
        processData: false,
        ...
        success: function (data) {
            if (data.status == true) {
                ...
                $('#frmAddReception').trigger("reset");
                $('#previewProfile').attr('src', '');
            }
            else {
                swal({
                    title: "Receptionist Not Created",
                    type: "warning",
                    text: data.message,
                    confirmButtonColor: "#00B4B4",
                });
        ...
        error: function (error) {
            console.log(error);
            swal({
                title: "Receptionist creating failed",
                type: "warning",
