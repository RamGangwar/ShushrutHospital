...
        public int Draw { get; set; }
        ...
        public string SortOrder
        {
            get
            {
                //  return Columns != null && Order != null && Order.Length > 0 ? (Columns[Order[0].Column].Data + (Order[0].Dir == DTOrderDir.DESC ? " " + Order[0].Dir : " " + Order[0].Dir)) : null;

                return Columns != null && Order != null && Order.Length > 0 ? Columns[Order[0].Column].Data : null;
            }
        }
